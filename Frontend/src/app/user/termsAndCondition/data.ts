...
// --- DATA, directly from your original code ---
export const data = [
  { heading: "1. Insurance:", text: [ "Full Comprehensive insurance is provided subject to current U.A.E Law. The Hirer is liable for the first AED [1200-3500] varies per car category - against claims resulting from each and every accident including (hit-and-run) reporting you at fault (as evidenced by a Police report). This can be waived by buying the super collision damage waiver (SCDW)." ] },
  { heading: "2. Kilometers Driven:", text: [ "Kilometers are limited to 250km/day or 1400km/week or 2500-5000km/month, where additional kilometers will be chargeable @ 0.3 - 0.5/km varies by vehicle’s group and category." ] },
  { heading: "3. Maintenance:", text: [ "It includes routine & major servicing at a certain km/mileage, as mentioned on the sticker attached to the vehicle’s windshield as per recommendations of its dealer. (Kindly refer to the same and collaborate with our fleet department on (02-5550029) for the due arrangements)." ] },
  { heading: "4. Replacement Vehicle/s:", text: [ "In the event of routine service and maintenance, a replacement vehicle nearest in size to the hired one, as is possible, will be provided at no extra cost." ] },
  { heading: "5. Accidents:", text: [ "In the event of any damage or accident to the car, police must be called before the vehicle is moved and a police report and a repair slip must be obtained.", "Should these documents fail to be obtained, then the Hirer is responsible for all damages incurred. “The obtaining of these documents will be the responsibility of the Hirer”." ] },
  { heading: "6. Traffic Violations & Salik:", text: [ "All costs incurred as a result of fines or other penalties (imposed by traffic police or any other legal authorities) taking place during the rental will be the client’s responsibility and would be recovered accordingly.", "Additional charges are applicable for Salik (Dubai Tollgate pass) at Dhs.5/pass.", "There will be an AED42 additional service charge on top of traffic fine charges and AED1/- on top of each Salik charge." ] },
  { heading: "7. Fuel, Water, Oil & Tire Pressure:", text: [ "Special or Unleaded fuel is to be used.", "20% service charge is added to the refueling cost.", "It is the responsibility of the hirer to check water and oil levels as well as tire pressure. Damages caused due to neglecting the same are not covered and would be considered vehicle misuse, with the due cost being the hirer’s liability." ] },
  { heading: "8. Vehicle Offhire or Check-In Policy: - “Condition & Nonsmoking”:", text: [ "The Hirer must keep the hired vehicle in a clean, safe, and sound condition. Otherwise charges may be applied.", "Smoking is prohibited inside Europcar Vehicles and offenders will be charged AE300/- against violating the same.", "Hirer must inform Europcar of his intention to return the vehicle at another premise or other Emirate, and must define the date and time otherwise excess days would be charged to him.", "At the time of vehicle’s off-hire, the cost of any un-reported damage/s as well as damages with no police report/s would be fully charged to hirer account." ] },
  { heading: "9. Driving License & Driver’s Age:", text: [
  ...
  { heading: "10. Payment & Deposit:", text: [
  ...
  { heading: "11. Delivery / Collection of vehicle:", text: [
  ...
  { heading: "12. Airport Surcharge:", text: [
  ...
  { heading: "13. Breakdown Service:", text: [
  ...
  { heading: "14. Additional Charges:", text: [
  ...
  { heading: "15. Additional Driver/s:", text: [
  ...
  { heading: "16. Value Added Tax (VAT):", text: [
  ...
  { heading: "17. Driving Outside UAE & Off-Road Driving", text: [
  ...
  { heading: "18. Non-Smoking Policy", text: [
  ...
  { heading: "19. Usage of Vehicle/s:-", text: [
  ...
  { heading: "20. Vehicle Check-out & Check-in:-", text: [
  ...
  { heading: "21. Vehicle Returns:-", text: [
    "Early Returns:-",
  ...
  { heading: "22. Grace Period of a Rental:", text: [
